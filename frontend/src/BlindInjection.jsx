...
function BlindInjection() {
    ...
    return (
        <div>
            ...
            <button className="btn btn-primary w-100 mt-3"  onClick={() => checkUser("user")}>Boolean-Based -- ' OR 1=1 -- </button>
            <button className="btn btn-primary w-100 mt-3"  onClick={() => checkUser("time")}>Time-Based -- admin' AND SLEEP(5) --</button>
            <button className="btn btn-primary w-100 mt-3" onClick={() => checkUser("union")}>Union-Based -- admin' UNION SELECT 1,2,3 --</button>
            <button className="btn btn-primary w-100 mt-3" onClick={() => checkUser("error")}>Error-Based -- admin' AND 1=CONVERT(int, (SELECT @@version)) --</button>
